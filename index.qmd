...
|  | `r advdate(fri,11)` | Distributions | 📖 | 📺 | [🖥️](slides/week-11.2.qmd "Week 11.2 slides") | [✍️](project/project-assignment-2.qmd "Project assignment 2") | `r advdate(mon,12)` |
...
|  | `r advdate(fri,13)` | Coding assignment 4 | 📖 | 📺 | [🖥️](slides/week-13.2.qmd "Week 13.2 slides") | [🧮](assignments/coding-assignment-4.qmd "Coding assingment 4") | `r advdate(mon,14)` |
