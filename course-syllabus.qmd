...
| Classroom: [1776 G. St., NW](https://maps.app.goo.gl/vXRsm4Ausht4q2469) Rm. C103
|
...
| Location: Online, email for link
|
| Credit Hours: 3.0.
|
...
-   [Post Cloud](https://posit.cloud): a cloud-based computing platform that allows you to run R code and render Quarto documents in the cloud.You will need to purchase a student subscription ($5/month) to access the class workspace.
