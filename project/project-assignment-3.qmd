...
## Component 1: RevealJS Presentation  
...
- Upload your RevealJS presentation to [Quarto Pub](https://quartopub.com/) and share the link on the designated platform (e.g., Discord).  
- Submit your QMD file and project folder to Blackboard.  

## Component 2: Final Written Report  
...
- Submit the link to the report to Discord and the project folder (including the QMD file) on Blackboard.  
